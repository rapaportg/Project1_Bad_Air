class StackedAreaChart {
    ...
    constructor(_config, _data) {
      this.config = {
        ...
        margin: _config.margin || {top: 200, right: 12, bottom: 30, left: 100},
        displayType: ''
      }
      this.data = _data;
      this.initVis();
    ...
    initVis() {
      ...
      vis.colorScale = d3.scaleOrdinal()
          .range(['#6080b5', '#5a9866', '#f7dc7a', '#ff5733', '#daf7a6']);
    ...
    updateVis() {
      ...
      if (vis.config.displayType == 'absolute') {
        vis.stack.value((d,key) => d[1][key].value);
      } else {
        ...
        vis.groupedData.forEach(g => {
          ...
          console.log(g);
          const yearSum = d3.sum(g[1], d => d.value);
        ...
        vis.stack.value((d,key) => d[1][key].relative);
      }
      ...
      vis.colorScale.domain([0,1,2,3,4]);
